...
const ContactLink: React.FC<ContactLinkProps> = ({ href, svgPath, title, fillColor }) => (
  <a href={href} target="_blank" rel="noopener noreferrer" aria-label={title} className="contact-link">
    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill={fillColor || 'currentColor'}>
      <title>{title}</title>
      <path d={svgPath} />
    </svg>
  </a>
